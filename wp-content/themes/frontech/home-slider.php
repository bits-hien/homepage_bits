...
<div id="kyma_owl_slider" class="owl-carousel">
	<?php for($i=1 ; $i<=3 ; $i++){ ?>
		<div class="item">
			...
			<div class="owl_slider_con">
				<h3 id="slide-title-<?php echo absint( $i ); ?>" class="title_big" itemprop="alternativeHeadline"><span><?php esc_html_e('Software outsourcing', 'frontech'); ?></span></h3>
				...
				<h4 id="slide-subtitle-<?php echo absint( $i ); ?>" class="small_subtitle" itemprop="alternativeHeadline"><?php esc_html_e('Software Outsourcing Service', 'frontech'); ?></h4>
			</div>
		</div>
	<?php } ?>
</div>
